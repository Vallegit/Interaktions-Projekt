    ...
    */
    ...
    render(){
        ...
        switch(this.props.status){
            ...
            case "LOADED":
                let backgroundURL = "";
                (window.matchMedia(`(max-width: 600px)`).matches) ? (backgroundURL = posterUrl+this.props.currentMovie.poster_path) : (backgroundURL = posterUrl+this.props.currentMovie.backdrop_path);
                backgroundImage = {
